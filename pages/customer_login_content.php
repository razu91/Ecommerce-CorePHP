    ...
    <div class="row">
        <div class="col-md-12">
            <div class="well text-center text-success">
                You may login from here. If you are not registered then please register first.
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="well">
                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input required="true" type="email" name="email_address" onblur="return customer_email_check(this.value, 'res');" class="form-control">
                        </div>
                        <br/>
                        <span id="res"></span>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <textarea required="true" class="form-control" name="address"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">Phone Number</label>
                        <div class="col-md-9">
                            <input required="true" type="number" name="phone_number" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">City</label>
                        <div class="col-md-9">
                            <input required="true" type="text" name="city" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-3 col-md-9">
                            <input required="true" type="submit" name="btn" value="Registration" class="btn btn-primary btn-block" id="reg_btn">
                        </div>
                    </div>
                </form>
            </div>
